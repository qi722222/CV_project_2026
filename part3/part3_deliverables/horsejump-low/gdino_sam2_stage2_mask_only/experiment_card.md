...
| motivation | 重点看重锚后是不是反而引入更多抖动或目标切换。 |
| expected_gain | 见 `plain_explanation` |
| actual_result | 当前整体不如 Stage1 稳，说明重锚不是越多越好。 |
| next_decision | 待实验结果更新 |

## 关键路径

- `mask_frames`: `/data3/jli657/project3/part3/gdino_vlm/masks/stage2/horsejump-low`
- `run_meta`: `/data3/jli657/project3/part3/gdino_vlm/masks/stage2/horsejump-low/run_meta.json`
