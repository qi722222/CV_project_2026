...
| motivation | 看第一帧检测框准不准，以及后续传播有没有漂移。 |
| expected_gain | 见 `plain_explanation` |
| actual_result | 在当前数据里，它依然是很强的参照，尤其 bmx-trees 上比 SAM3 更稳。 |
| next_decision | 待实验结果更新 |

## 关键路径

- `mask_frames`: `/data3/jli657/project3/part3/gdino_vlm/masks/stage1/horsejump-low`
- `run_meta`: `/data3/jli657/project3/part3/gdino_vlm/masks/stage1/horsejump-low/run_meta.json`
- `script_path`: `/data3/jli657/project3/part3/gdino_vlm/run_gdino_mainline.py`
- `config_path`: `/data3/jli657/project3/part3/configs/gdino_vlm_mainline.yaml`
