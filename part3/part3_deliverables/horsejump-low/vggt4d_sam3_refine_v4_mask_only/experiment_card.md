...
| motivation | 重点看它相对 v5 差在哪里，是召回不够还是边界还不够稳。 |
| expected_gain | 见 `plain_explanation` |
| actual_result | 它接近可用，但最终汇总主要还是用 v5。 |
| next_decision | 待实验结果更新 |

## 关键路径

- `mask_frames`: `/data3/jli657/project3/part3/outputs/direction_b/sam3_refined_v4/vggt4d/horsejump-low`
...
- `prompt_frame`: `00000`
- `JM`: `0.00024201757930242853`
- `JR`: `0.0`
- `F`: `0.007166664480072098`
