...
| motivation | 看重锚是否真修复了漂移，还是把错误框继续传播了。 |
| expected_gain | 见 `plain_explanation` |
| actual_result | 当前它比 GDINO+SAM3 Stage1 还低，说明现有重锚设计不够稳。 |
| next_decision | 待实验结果更新 |

## 关键路径

- `mask_frames`: `/data3/jli657/project3/part3/gdino_vlm/masks/sam3/stage2/horsejump-low`
- `run_meta`: `/data3/jli657/project3/part3/gdino_vlm/masks/sam3/stage2/horsejump-low/run_meta.json`
- `script_path`: `/data3/jli657/project3/part3/gdino_vlm/run_gdino_mainline.py`
- `config_path`: `/data3/jli657/project3/part3/configs/gdino_vlm_mainline_sam3_stage2.yaml`
