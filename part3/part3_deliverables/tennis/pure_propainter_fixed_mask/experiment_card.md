...
| motivation | 重点看在 mask 已经固定时，ProPainter 是否能稳定补背景、不闪烁。 |
| expected_gain | 见 `plain_explanation` |
| actual_result | 它是 inpaint-only 的强基线，经常是最难被超过的一条。 |
| next_decision | 待实验结果更新 |

## 关键路径

- `mask_frames`: `/data3/jli657/project3/part3/results/tennis/mask_frames`
- `source_output_dir`: `/data3/jli657/project3/part3/results/tennis/direction_c/pure_propainter`
- `inpaint_out`: `/data3/jli657/project3/part3/results/tennis/direction_c/pure_propainter/inpaint_out.mp4`
- `masked_in`: `/data3/jli657/project3/part3/results/tennis/direction_c/pure_propainter/masked_in.mp4`
- `script_path`: `/data3/jli657/project3/part3/eval/evaluate_all.py`

## 指标摘录

- `PSNR_proxy`: `34.8786`
- `PSNR_synthetic`: `8.4165`
- `SSIM`: `nan`
- `n_frames`: `70`
