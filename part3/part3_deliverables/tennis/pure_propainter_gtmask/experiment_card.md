...
- `source_output_dir`: `/data3/jli657/project3/part3/results/tennis/direction_c/pure_propainter_gtmask`
- `inpaint_out`: `/data3/jli657/project3/part3/results/tennis/direction_c/pure_propainter_gtmask/inpaint_out.mp4`
- `masked_in`: `/data3/jli657/project3/part3/results/tennis/direction_c/pure_propainter_gtmask/masked_in.mp4`
- `script_path`: `/data3/jli657/project3/part3/inpainting/run_propainter_gtmask.py`

## 指标摘录

- `PSNR_proxy`: `34.9782`
- `PSNR_synthetic`: `8.3517`
- `SSIM`: `0.9298`
- `n_frames`: `70`
