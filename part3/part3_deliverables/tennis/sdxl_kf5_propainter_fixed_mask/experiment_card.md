...
- `source_output_dir`: `/data3/jli657/project3/part3/results/tennis/direction_c/sdxl_kf5_propainter`
- `inpaint_out`: `/data3/jli657/project3/part3/results/tennis/direction_c/sdxl_kf5_propainter/inpaint_out.mp4`
- `masked_in`: `/data3/jli657/project3/part3/results/tennis/direction_c/sdxl_kf5_propainter/masked_in.mp4`
- `script_path`: `/data3/jli657/project3/part3/inpainting/run_phase2_sdxl_all7.py`

## 指标摘录

- `PSNR_proxy`: `34.2062`
- `PSNR_synthetic`: `9.1275`
- `SSIM`: `nan`
- `n_frames`: `70`
