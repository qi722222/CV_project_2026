...
| motivation | 重点看高速运动时 mask 是否更连续、是否少了断裂和目标切换。 |
| expected_gain | 见 `plain_explanation` |
| actual_result | 这是目前 GDINO+SAM3 创新里最有正向信号的一条。 |
| next_decision | 待实验结果更新 |

## 关键路径

- `mask_frames`: `/data3/jli657/project3/part3/gdino_vlm/masks/sam3/innovation/o2o_assoc/bmx-trees`
- `run_meta`: `/data3/jli657/project3/part3/gdino_vlm/masks/sam3/innovation/o2o_assoc/bmx-trees/run_meta.json`
- `script_path`: `/data3/jli657/project3/part3/gdino_vlm/run_gdino_mainline.py`
- `config_path`: `/data3/jli657/project3/part3/configs/gdino_vlm_sam3_innov_o2o.yaml`
