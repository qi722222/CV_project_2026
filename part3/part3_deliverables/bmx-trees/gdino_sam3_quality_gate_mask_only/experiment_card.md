...
| motivation | 重点看门控到底有没有真的触发，而不是只看名字觉得它很高级。 |
| expected_gain | 见 `plain_explanation` |
| actual_result | 现有阈值下几乎没带来增益，更像一次未充分触发的尝试。 |
| next_decision | 待实验结果更新 |

## 关键路径

- `mask_frames`: `/data3/jli657/project3/part3/gdino_vlm/masks/sam3/innovation/quality_gate/bmx-trees`
- `run_meta`: `/data3/jli657/project3/part3/gdino_vlm/masks/sam3/innovation/quality_gate/bmx-trees/run_meta.json`
- `script_path`: `/data3/jli657/project3/part3/gdino_vlm/run_gdino_mainline.py`
- `config_path`: `/data3/jli657/project3/part3/configs/gdino_vlm_sam3_innov_quality_gate.yaml`
